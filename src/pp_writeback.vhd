...
entity pp_writeback is
	...
	port(
		...
		count_instr_csr_in  : in std_logic;
		count_instr_csr_out : out std_logic;
		...
		op_num_in    	: in integer range 0 to LENGTH_MAIN;
		op_num_out   	: out integer range 0 to LENGTH_MAIN;
		jump_taken_in  	: in std_logic;
		jump_taken_out 	: out std_logic;
